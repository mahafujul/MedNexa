...
async function statusChangeHandler(appointmentId: string) {
  try {
    const response = await axios.put(
      `/api/admin/appointments/change-status/${appointmentId}`
    );
...
// Main component for displaying appointments
export default function AllAppointments({}: Props) {
  ...
  async function fetchAllAppointments() {
    try {
      setLoading(true);
      const response = await axios.get("/api/admin/appointments/get-all");
