 ...
 * Description: This component allows updating details of a doctor.
 * It fetches the doctor's current details using the doctorId parameter,
 * populates a form with these details for editing, and submits the updated
 * information to the server via a PUT request.
 */
"use client";
...
function UpdateDetails({}: Props) {
  ...
  useEffect(() => {
    (async function () {
      try {
        setLoading(true);
        const response = await axios.get("/api/admin/doctors/profile", {
          params: {
            doctorId,
          },
        });
