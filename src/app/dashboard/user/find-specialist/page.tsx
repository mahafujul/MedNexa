        ...
        <div className='flex justify-center md:mt-[100px]'>
          <Card className="w-[500px]">
            <CardHeader>
              ...
              <CardDescription>to get specialist doctors recommendation.</CardDescription>
            </CardHeader>
            <CardContent>
              {/* Form section */}
              <form>
                <div className="grid w-full items-center gap-4">
                  ...
                  <div className="flex flex-col space-y-1.5">
                    <Label className="pb-2" htmlFor="framework">How many symptoms you want to enter?</Label>
                    <Select onValueChange={(value) => { setNumberOfSymptoms(Number(value)) }}>
                        ...
                        <div className="flex flex-col space-y-1.5">
                          <div>
                            ...
                            <Popover
                              ...
                              onOpenChange={(open) => handlePopoverChange(index, open)}
                            >
                              <PopoverTrigger asChild>
                                ...
                                >
                                  {symptomState.value
                                    ? symptoms.find((item) => item.symptom === symptomState.value)?.symptom
                                      ...
                                      {symptoms.map((item) => (
                                        <CommandItem
                                          ...
                                          onSelect={(currentValue) => {
                                            handleSymptomChange(index, currentValue === symptomState.value ? "" : currentValue)
                                        ...
                                        >
                                          ...
                                          <CheckIcon
                                            className={cn(
                                              "ml-auto h-4 w-4",
                                              selectedSymptoms.includes(item.symptom) ? "opacity-100" : "opacity-0"
                                            )}
                                          />
                                        </CommandItem>
                                      ))}
            ...
            <CardFooter className="flex justify-between">
              {/* Clear button */}
              <Button variant="outline" onClick={ ()=> setSymptomStates(Array.from({ length: numberOfSymptoms }, () => ({ open: false, value: "" })))}>Clear</Button>
              {/* Find button */}
              <Button onClick={()=>{console.log(selectedSymptoms)}}>Find</Button>
            </CardFooter>
          </Card>
        </div>
      </LayoutBody>
