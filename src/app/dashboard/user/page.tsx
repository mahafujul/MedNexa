          ...
          <div>
            ...
            <Card className="bg-gray-900 relative">
              <CardHeader>
                ...
                <CardContent>
                  <div className='text-2xl font-bold py-5 text-white'>{user?.username}.</div>
                  <p className='text-md text-muted-foreground pb-6 text-white'>
                    Need a Specialist? No problem! Let's Find One for You.<br />
                    Tell us about your symptoms, and we'll match you with the best expert for your recovery.<br />
                    Simply choose a convenient time slot.
                  </p>
                  <Button onClick={() => router.push("/dashboard/user/enter-symptoms")}>
                    Find Specialist
                  </Button> {/* Button to navigate to the enter symptoms page */}
                </CardContent>
              </CardHeader>
            </Card>
          </div>
            ...
            <div className='col-span-1 lg:col-span-6'>
              <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-2'>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold'>{user?.todaySessions?.length}</div>
                    <p className='text-xs text-muted-foreground'>
                      +201 since last hour
                    </p>
                  </CardContent>
